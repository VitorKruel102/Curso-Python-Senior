...
while True:    
    ...
    if modifica_carrinho == 'i':
        ...
        print(f'Este é a suas lista de compras: {carrinho_de_compras}')
        ...
        if not produto in carrinho_de_compras:
            print('Não temos esse produto na lista, tente novamente mais tarde.')
            continue
        ...
        print(f'Este é a suas lista de compras: {carrinho_de_compras}')
        print('Suas compras estão finalizadas. Obrigado pela preferência.')
        break
    else:
